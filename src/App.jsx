...
function App() {
  ...
  return (
    <>
      <header className="bg-[#1a1919] bg-cover bg-center h-full flex flex-col justify-center items-center relative">
        <picture>
          <source
            srcSet={herodesktop}
        ...
        <div className="text-gray-100 absolute mx-4 justify-center items-center text-center lg:text-left lg:top-48 lg:left-32 lg:w-[30%] py-4">
          <h5 className=" text-[20px] text-gray-400 tracking-widest mb-4">
            NEW PRODUCT
          </h5>
          ...
          <Link to={"/headPhones"}>
            <button className="bg-[#D87D4A] hover:bg-[#FBAF85] text-white font-bold py-2 px-6 rounded mt-4">
              See Product
            </button>
          </Link>
        </div>
      ...
      <main className="h-full w-screen flex flex-col">
        ...
        <div className="zx9-speaker grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2  my-auto mb-14 md:mb-14 lg:mb-16  mx-8 bg-[#D87D4A]  lg:gap-4 items-center  justify-center p-4 h-[700px] lg:h-[400px] lg:mx-28 rounded-md bg-[url(./home/desktop/pattern-circles.svg')] bg-right-top ">
          ...
          <div className=" w-full h-full rounded-sm p-12 flex flex-col justify-center items-center lg:items-left text-center md:text-center lg:text-left lg:top-48 lg:left-32 lg:w-[80%] ">
            <h3 className="text-4xl mb-4 font-bold tracking-wide text-gray-100">
              ZX9 SPEAKERS
            </h3>
            ...
            <Link to={"/speakers"}>
              <button className="bg-[#000000] hover:bg-[#616060] text-white font-bold py-2 rounded mt-4 left-0 w-32">
                See Product
              </button>
            </Link>
          </div>
        </div>
        <div className="zx7-speaker mb-16  mx-auto lg:gap-4 items-center justify-center p-4 h-full lg:h-[300px]  rounded-md bg-right-top relative">
          <picture>
          ...
          <div className=" absolute left-16 top-12">
            <h3 className="text-4xl mb-4 text-gray-900 tracking-wid font-semibold">
              ZX7 SPEAKER
            </h3>
        ...
        <div className="earphone grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2  my-auto mb-12 lg:my-16  mx-8 gap-16  lg:gap-4 items-center  justify-center  lg:mx-28 rounded-md  ">
          <div className=" h-full w-full">
            <picture>
